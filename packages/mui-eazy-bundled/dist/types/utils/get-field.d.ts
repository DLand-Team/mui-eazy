...
export declare const getField: <T extends "string" | "select" | "checkbox" | "radio" | "multiple" | "editer" | "autoCompleteGoogle" | "datePicker" | "upload" | "uploadBox" | "multiSelect">(type: T) => {
    radio: typeof FieldRadioGroup;
    select: typeof FieldSelect;
    editer: typeof FieldEditor;
    autoCompleteGoogle: typeof FieldAutocompleteGoogle;
